...
<h1 align="center">@rapiq/adapter-memory</h1>

<p align="center">
  <b>Evaluate a rapiq <code>Query</code> against plain JavaScript objects & arrays.</b><br>
  The in-memory sibling of <code>@rapiq/adapter-sql</code> and <code>@rapiq/adapter-typeorm</code>: same AST,<br>
  compiled into plain functions instead of SQL.
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/@rapiq/adapter-memory"><img src="https://img.shields.io/npm/v/@rapiq/adapter-memory/beta?color=%23a21caf&label=npm" alt="npm version"></a>
  <a href="https://www.npmjs.com/package/@rapiq/adapter-memory"><img src="https://img.shields.io/npm/types/@rapiq/adapter-memory?color=%23db2777" alt="types"></a>
  <a href="https://github.com/tada5hi/rapiq/blob/master/LICENSE"><img src="https://img.shields.io/npm/l/@rapiq/adapter-memory?color=blue" alt="License: MIT"></a>
</p>

<p align="center">
  <a href="https://rapiq.tada5hi.net/packages/adapter-memory"><b>Documentation</b></a>
  ·
  <a href="https://github.com/tada5hi/rapiq">Monorepo</a>
  ·
  <a href="https://www.npmjs.com/package/@rapiq/adapter-memory">npm</a>
</p>
...
To find out more, head over to the [documentation](https://rapiq.tada5hi.net/packages/adapter-memory).
