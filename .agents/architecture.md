...
- **Every issue is a failure.** No `severity`, and under a dropping policy a site records NOTHING (`IssueCollector.add` returns early). Notices for substituted defaults or entries a rejected relation dragged along were removed with it.
